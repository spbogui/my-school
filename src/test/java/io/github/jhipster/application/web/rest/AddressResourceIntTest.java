...
public class AddressResourceIntTest {
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getMobilePhone()).isEqualTo(DEFAULT_MOBILE_PHONE);
        assertThat(testAddress.getOfficePhone()).isEqualTo(DEFAULT_OFFICE_PHONE);
        assertThat(testAddress.getHomePhone()).isEqualTo(DEFAULT_HOME_PHONE);
        assertThat(testAddress.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testAddress.getPostalAddress()).isEqualTo(DEFAULT_POSTAL_ADDRESS);
        ...
        assertThat(testAddress.isIsPreferred()).isEqualTo(DEFAULT_IS_PREFERRED);
    ...
    public void updateAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getMobilePhone()).isEqualTo(UPDATED_MOBILE_PHONE);
        assertThat(testAddress.getOfficePhone()).isEqualTo(UPDATED_OFFICE_PHONE);
        assertThat(testAddress.getHomePhone()).isEqualTo(UPDATED_HOME_PHONE);
        assertThat(testAddress.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testAddress.getPostalAddress()).isEqualTo(UPDATED_POSTAL_ADDRESS);
        ...
        assertThat(testAddress.isIsPreferred()).isEqualTo(UPDATED_IS_PREFERRED);
