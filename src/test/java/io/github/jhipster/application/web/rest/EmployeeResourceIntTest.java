...
public class EmployeeResourceIntTest {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getHiringDate()).isEqualTo(DEFAULT_HIRING_DATE);
        assertThat(testEmployee.getEmploymentStartDate()).isEqualTo(DEFAULT_EMPLOYMENT_START_DATE);
    ...
    @Test
    @Transactional
    public void checkEmploymentStartDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setEmploymentStartDate(null);
    ...
    public void updateEmployee() throws Exception {
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getHiringDate()).isEqualTo(UPDATED_HIRING_DATE);
        assertThat(testEmployee.getEmploymentStartDate()).isEqualTo(UPDATED_EMPLOYMENT_START_DATE);
