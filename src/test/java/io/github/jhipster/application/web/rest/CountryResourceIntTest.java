...
public class CountryResourceIntTest {
    ...
    private static final String DEFAULT_WOMAN_NAME = "AAAAAAAAAA";
    private static final String UPDATED_WOMAN_NAME = "BBBBBBBBBB";
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country()
            .name(DEFAULT_NAME)
            .manName(DEFAULT_MAN_NAME)
            .womanName(DEFAULT_WOMAN_NAME);
        return country;
    }
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getManName()).isEqualTo(DEFAULT_MAN_NAME);
        assertThat(testCountry.getWomanName()).isEqualTo(DEFAULT_WOMAN_NAME);
    ...
    @Test
    @Transactional
    public void checkManNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = countryRepository.findAll().size();
        // set the field null
        country.setManName(null);
    ...
    @Test
    @Transactional
    public void checkWomanNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = countryRepository.findAll().size();
        // set the field null
        country.setWomanName(null);
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].manName").value(hasItem(DEFAULT_MAN_NAME.toString())))
            .andExpect(jsonPath("$.[*].womanName").value(hasItem(DEFAULT_WOMAN_NAME.toString())));
    }
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.manName").value(DEFAULT_MAN_NAME.toString()))
            .andExpect(jsonPath("$.womanName").value(DEFAULT_WOMAN_NAME.toString()));
    }
    ...
    public void updateCountry() throws Exception {
        ...
        updatedCountry
            .name(UPDATED_NAME)
            .manName(UPDATED_MAN_NAME)
            .womanName(UPDATED_WOMAN_NAME);
        ...
        assertThat(testCountry.getManName()).isEqualTo(UPDATED_MAN_NAME);
        assertThat(testCountry.getWomanName()).isEqualTo(UPDATED_WOMAN_NAME);
    ...
    public void searchCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/_search/countries?query=id:" + country.getId()))
            ...
            .andExpect(jsonPath("$.[*].womanName").value(hasItem(DEFAULT_WOMAN_NAME)));
    }
