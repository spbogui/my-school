...
import { LeaveHoliDayComponent } from 'app/entities/leave-holi-day/leave-holi-day.component';
...
describe('Component Tests', () => {
    describe('LeaveHoliDay Management Component', () => {
        let comp: LeaveHoliDayComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LeaveHoliDayComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.leaveHoliDays[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
