...
import { ActorNameComponent } from 'app/entities/actor-name/actor-name.component';
...
describe('Component Tests', () => {
    describe('ActorName Management Component', () => {
        let comp: ActorNameComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ActorNameComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.actorNames[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
