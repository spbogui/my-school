...
describe('Service Tests', () => {
    describe('PeriodType Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new PeriodType(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PeriodType', async () => {
            ...
            it('should update a PeriodType', async () => {
                const returnedFromService = Object.assign(
                    {
                        periodLabel: 'BBBBBB',
                        description: 'BBBBBB'
            ...
            it('should return a list of PeriodType', async () => {
                const returnedFromService = Object.assign(
                    {
                        periodLabel: 'BBBBBB',
                        description: 'BBBBBB'
            ...
            it('should delete a PeriodType', async () => {
