...
import { EnrolmentComponent } from 'app/entities/enrolment/enrolment.component';
...
describe('Component Tests', () => {
    describe('Enrolment Management Component', () => {
        let comp: EnrolmentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EnrolmentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.enrolments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
