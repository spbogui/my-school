...
import { ClassSessionComponent } from 'app/entities/class-session/class-session.component';
...
describe('Component Tests', () => {
    describe('ClassSession Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.classSessions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
