...
import { ResponsibleComponent } from 'app/entities/responsible/responsible.component';
...
describe('Component Tests', () => {
    describe('Responsible Management Component', () => {
        let comp: ResponsibleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResponsibleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.responsibles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
