...
import { IDiploma, Diploma } from 'app/shared/model/diploma.model';
...
describe('Service Tests', () => {
    describe('Diploma Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DiplomaService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Diploma(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Diploma', async () => {
                const returnedFromService = Object.assign(
                    {
                        diplomaLabel: 'BBBBBB',
                        description: 'BBBBBB'
