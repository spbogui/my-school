...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', async () => {
        ...
        expect(await employeeComponentsPage.getTitle()).to.eq('mySchoolApp.employee.home.title');
    });
    ...
    it('should load create Employee page', async () => {
        ...
        expect(await employeeUpdatePage.getPageTitle()).to.eq('mySchoolApp.employee.home.createOrEditLabel');
    ...
    it('should create and save Employees', async () => {
        ...
        await employeeComponentsPage.clickOnCreateButton();
        await promise.all([
            employeeUpdatePage.setHiringDateInput('2000-12-31'),
            employeeUpdatePage.setEmploymentStartDateInput('2000-12-31'),
            employeeUpdatePage.actorSelectLastOption()
        ]);
        expect(await employeeUpdatePage.getHiringDateInput()).to.eq('2000-12-31');
        expect(await employeeUpdatePage.getEmploymentStartDateInput()).to.eq('2000-12-31');
    ...
    it('should delete last Employee', async () => {
        ...
        expect(await employeeDeleteDialog.getDialogTitle()).to.eq('mySchoolApp.employee.delete.question');
