...
export class TeacherMissingSessionComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-teacher-missing-session div table .btn-danger'));
    title = element.all(by.css('jhi-teacher-missing-session div h2#page-heading span')).first();
...
export class TeacherMissingSessionUpdatePage {
    pageTitle = element(by.id('jhi-teacher-missing-session-heading'));
...
export class TeacherMissingSessionDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-teacherMissingSession-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-teacherMissingSession'));
