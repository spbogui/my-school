...
describe('Country e2e test', () => {
    ...
    it('should load Countries', async () => {
        ...
        expect(await countryComponentsPage.getTitle()).to.eq('mySchoolApp.country.home.title');
    });
    ...
    it('should load create Country page', async () => {
        ...
        expect(await countryUpdatePage.getPageTitle()).to.eq('mySchoolApp.country.home.createOrEditLabel');
    ...
    it('should create and save Countries', async () => {
        ...
        await promise.all([
            ...
            countryUpdatePage.setManNameInput('manName'),
            countryUpdatePage.setWomanNameInput('womanName')
        ]);
        expect(await countryUpdatePage.getNameInput()).to.eq('name');
        expect(await countryUpdatePage.getManNameInput()).to.eq('manName');
        expect(await countryUpdatePage.getWomanNameInput()).to.eq('womanName');
    ...
    it('should delete last Country', async () => {
        ...
        expect(await countryDeleteDialog.getDialogTitle()).to.eq('mySchoolApp.country.delete.question');
