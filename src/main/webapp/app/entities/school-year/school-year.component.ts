...
export class SchoolYearComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.schoolYearService
                ...
                .subscribe(
                    (res: HttpResponse<ISchoolYear[]>) => this.paginateSchoolYears(res.body, res.headers),
    ...
    trackId(index: number, item: ISchoolYear) {
        return item.id;
    }
    ...
    protected paginateSchoolYears(data: ISchoolYear[], headers: HttpHeaders) {
