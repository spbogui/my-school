...
export class StudentEvaluationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.studentEvaluationService
                ...
                .subscribe(
                    (res: HttpResponse<IStudentEvaluation[]>) => this.paginateStudentEvaluations(res.body, res.headers),
    ...
    trackId(index: number, item: IStudentEvaluation) {
        return item.id;
    }

    registerChangeInStudentEvaluations() {
        this.eventSubscriber = this.eventManager.subscribe('studentEvaluationListModification', response => this.loadAll());
    }
    ...
    protected paginateStudentEvaluations(data: IStudentEvaluation[], headers: HttpHeaders) {
